...
// Назначение: Математические расчеты для GPX данных

// Функции:
// calculateDistance - расстояние между точками (Haversine)
// calculateSpeed - скорость между точками
// normalizeTracks - нормализация треков к одинаковому числу точек
// calculateLag - расчет отставания между двумя треками
// findKeySegments - поиск участков с максимальным отставанием
/**
